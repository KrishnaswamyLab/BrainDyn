...
def run_forecasting_epoch(
    ...
    for batch in pbar:
        x_history, y_true = batch_to_model_tensors_nest(batch, edge_index.device)
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--cv_folds", type=int, default=5, help="Number of cross-validation folds over the combined forecasting train+val pool.")
