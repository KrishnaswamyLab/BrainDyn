...
#SBATCH --job-name=braindyn_tusz_binary
...
uv run train_tusz_binary.py \
  ...
  --save_forecast_path checkpoints/braindyn_tusz_binary_forecast_best.pt \
  --save_classifier_path checkpoints/braindyn_tusz_binary_classifier_best.pt
