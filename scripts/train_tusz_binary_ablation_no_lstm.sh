...
uv run train_tusz_binary.py \
  ...
  --save_forecast_path checkpoints/braindyn_tusz_binary_no_lstm_forecast_best.pt \
  --save_classifier_path checkpoints/braindyn_tusz_binary_no_lstm_classifier_best.pt
