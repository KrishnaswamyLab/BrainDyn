...
unperturbed rates with context-only z-scoring; ``perturb_forecast`` adds aligned
perturbed futures (same windows, horizon normalised with **original** context
mean/std for counterfactual evaluation); ``perturbation`` mode returns full
